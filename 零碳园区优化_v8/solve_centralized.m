...
uH2ch = binvar(N,T,'full');   % 1: charging hydrogen, 0: discharging hydrogen
...
for i = 1:N
    for t = 1:T
        ...
        F = [F, H2prod(i,t) + H2dis(i,t) + H2short(i,t) == data.H2load(i,t) + H2cons_fc(i,t) + H2ch(i,t)];
        ...
        F = [F, Pgrid(i,t) + PpvUse(i,t) + PwindUse(i,t) + Pchp(i,t) + Pfc(i,t) + Pdis(i,t) ...
             == data.Pload(i,t) + Peb(i,t) + Pelec(i,t) + Pch(i,t) + Pcomp(i,t)];
        F = [F, Pinj(i,t) == Pgrid(i,t)];
        F = [F, Qinj(i,t) == data.Qbase(i,t) + data.QcompCoeff(i)*Pcomp(i,t) - Qpv(i,t) - Qes(i,t)];
