...
dataFields = {'Pload','PloadFixed','PdrShiftBase','PdrShiftMax','PdrCutEmax', ...
...
sumSolFields = {'Pgrid','Pch','Pdis','PpvUse','PpvCurt','PwindUse','PwindCurt', ...
    ...
    'Hch','Hdis','H2ch','H2dis','H2short','Hdump','PdrShift','PdrShiftDev','PdrCutE','HdrCut','H2drCut', ...
    'PloadDR','HloadDR','H2loadDR','Qpv','Qwind','Qes','QinjLocal','PinjLocal', ...
...
solFields = {'Pgrid','Pch','Pdis','SOC_e','PpvUse','PpvCurt','PwindUse','PwindCurt', ...
    ...
    'PdrShift','PdrShiftDev','PdrCutE','HdrCut','H2drCut','PloadDR','HloadDR','H2loadDR', ...
    'Qpv','Qwind','Qes','QinjLocal','PinjLocal','V', ...
    'CarbonEmission_kg','CarbonQuota_kg','CarbonBuyMarket_kg','CarbonSellMarket_kg', ...
    'CarbonTradeWithCommunities_kg','CarbonUnusedAllowance_kg'};
...
row.TotalPdrShiftDeviation_MWh = first_scalar(sol, {'totalPdrShiftDev'}, NaN);
row.TotalElectricCurtailmentDR_MWh = first_scalar(sol, {'totalPdrCutE'}, NaN);
row.TotalHeatCurtailmentDR_MWh = first_scalar(sol, {'totalHdrCut'}, NaN);
row.TotalHydrogenCurtailmentDR_kg = first_scalar(sol, {'totalH2drCut'}, NaN);

partNames = {'gridCost','carbonTradingCost','gasCost','gasCarbonCost','pvCurtCost','windCurtCost','h2ShortCost','demandResponseCost','qSupportCost'};
