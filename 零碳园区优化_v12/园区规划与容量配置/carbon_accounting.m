...
useFixedQuota = isfield(data, 'carbonQuotaMode') ...
    && strcmpi(char(data.carbonQuotaMode), 'fixed-baseline') ...
    && isfield(data, 'fixedCarbonQuota_kg') ...
    && ~isempty(data.fixedCarbonQuota_kg);
