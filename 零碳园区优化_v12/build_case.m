...
%% Thermal storage
HchMax   = [2.50; 4.15; 1.50];         % MW
HdisMax  = [2.50; 4.15; 1.50];         % MW
EthMax   = [10.0; 16.571; 6.0];           % MWh
SOC0_th  = 0.50 * EthMax;
etaCh_th = 0.95 * ones(N,1);
etaDis_th= 0.95 * ones(N,1);

%% 储氢系统
H2chMax  = [17.8; 13.3; 30.0];         % kg/h
H2disMax = [17.8; 13.3; 30.0];         % kg/h
EH2Max   = [106.30; 142.5; 240.0];        % kg
SOC0_h2  = 0.50 * EH2Max;
