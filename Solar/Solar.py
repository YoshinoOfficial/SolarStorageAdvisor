...
weather = pd.DataFrame({
    ...
    'dni': clearsky['dni'],
    'dhi': clearsky['dhi'],
    'temp_air': 30,    # 假设夏日气温 30°C
    'wind_speed': 2    # 假设微风 2 m/s
}, index=times)
...
array = Array(mount=mount, module_parameters=module_params, temperature_model_parameters={'a': -3.56, 'b': -0.075, 'deltaT': 3})
